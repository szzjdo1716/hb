window.ENTER_DATA = {
  ...
  tools: [
    ...
    },
    {
      ...
      title_zh: "SQLite 命令行",
      title_en: "SQLite CLI",
      blurb_zh: "进去 sqlite3 文件；出来 .quit 或 Ctrl-D。没有服务器，关掉文件就离开。详情见数据库入门。",
      blurb_en: "Enter with sqlite3 file; leave with .quit or Ctrl-D. No server — leaving the file is enough. See SQL with SQLite for the full lesson.",
