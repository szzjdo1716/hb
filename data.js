window.LINUX_DATA = {
  ...
  commands: [
    ...
    },
    {
      ...
      shortcuts: [
        { key: "nano FILE", meaning_zh: "打开文件（开始）", meaning_en: "Open a file (start)" },
        { key: "Ctrl+X", meaning_zh: "退出（会问是否保存）", meaning_en: "Quit (asks to save)" },
        { key: "Ctrl+O", meaning_zh: "保存", meaning_en: "Save" },
        { key: "Ctrl+W", meaning_zh: "搜索文字", meaning_en: "Search" },
        { key: "Ctrl+K", meaning_zh: "剪下一行", meaning_en: "Cut the current line" },
        { key: "Ctrl+U", meaning_zh: "粘贴", meaning_en: "Paste" },
        { key: "Ctrl+G", meaning_zh: "打开帮助", meaning_en: "Open help" },
      ],
      links: [
    ...
    },
    {
      ...
      shortcuts: [
        { key: "vi FILE", meaning_zh: "打开文件（开始）", meaning_en: "Open a file (start)" },
        { key: ":wq", meaning_zh: "保存并退出", meaning_en: "Save and quit" },
        { key: ":q!", meaning_zh: "不保存就退出", meaning_en: "Quit without saving" },
        { key: "i", meaning_zh: "进入插入模式，开始打字", meaning_en: "Insert mode — type text" },
        { key: "Esc", meaning_zh: "回到命令模式", meaning_en: "Back to command mode" },
        { key: ":w", meaning_zh: "保存，不退出", meaning_en: "Save, stay in the file" },
        { key: "/word", meaning_zh: "向下搜索 word", meaning_en: "Search forward for word" },
        { key: "n", meaning_zh: "下一个匹配", meaning_en: "Next match" },
        { key: "u", meaning_zh: "撤销上一步", meaning_en: "Undo" },
        { key: "dd", meaning_zh: "删除当前行", meaning_en: "Delete the current line" },
      ],
      links: [
    ...
    },
    {
      ...
      shortcuts: [
        { key: "vim FILE", meaning_zh: "打开文件（开始）", meaning_en: "Open a file (start)" },
        { key: ":wq", meaning_zh: "保存并退出", meaning_en: "Save and quit" },
        { key: ":q!", meaning_zh: "不保存就退出", meaning_en: "Quit without saving" },
        { key: "i", meaning_zh: "进入插入模式，开始打字", meaning_en: "Insert mode — type text" },
        { key: "Esc", meaning_zh: "回到命令模式", meaning_en: "Back to command mode" },
        ...
        { key: "u", meaning_zh: "撤销上一步", meaning_en: "Undo" },
        { key: "dd", meaning_zh: "删除当前行", meaning_en: "Delete the current line" },
        { key: ":help", meaning_zh: "打开 vim 帮助", meaning_en: "Open vim help" },
      ],
      links: [
